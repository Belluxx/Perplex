...
const DIVERGE_AGREE: Color32 = Color32::from_rgb(152, 190, 210);
const DIVERGE_NEUTRAL: Color32 = Color32::from_rgb(195, 185, 195);
const DIVERGE_DISAGREE: Color32 = Color32::from_rgb(195, 110, 110);
